        ...
        {services
          ...
          .map((service) => {
            return (
              ...
              >
                <div className="w-1/2 bg-slate-800 flex justify-center items-center text-slate-100 text-md sm:text-lg font-light rounded-md">
                  {service.title}
                </div>
                <div className="w-1/2 bg-slate-800 flex justify-center items-center text-md sm:text-lg font-light gap-2 rounded-md">
